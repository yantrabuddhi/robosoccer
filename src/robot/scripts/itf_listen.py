...
def process_speech():
    ...
    pubs = rospy.Publisher('/sense/stt/get_text', String,queue_size=10)
    pubc = rospy.Publisher('/sense/stt/confidence', Int8,queue_size=10)
    pubActive = rospy.Publisher('/act/robot/set_listen_led', Bool,queue_size=10)
    rospy.set_param('/sense/stt/get_listen_active',listen_active)
